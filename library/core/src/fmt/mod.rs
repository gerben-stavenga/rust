...
impl<'a> Arguments<'a> {
    ...
    pub unsafe fn new<const N: usize, const M: usize>(
        descriptor: &'static rt::Descriptor<N>,
    ...
    // Selects associated static storage from the zero-sized formatter list generated by rustc.
    #[inline]
    pub fn new_descriptor<
        L: rt::FormatList<M> + rt::DescriptorFor<N, M, B>,
        const N: usize,
        const M: usize,
        const B: [u8; N],
    >(
        _: L,
    ) -> &'static rt::Descriptor<N> {
        L::DESCRIPTOR
    }
